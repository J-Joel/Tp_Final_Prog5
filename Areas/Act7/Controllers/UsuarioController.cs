...
namespace TP_Final_Programacion5.Areas.Act7.Controllers
{
    ...
    {
        [Authorize(AuthenticationSchemes = "AreaAct7Cookies")]
        ...
        public IActionResult Login(string usuario, string contraseña)
        {
            ...
            if (user != null) {
                ...
                var claimsIdentity = new ClaimsIdentity(claims, "AreaAct7Cookies"); // Tiene que tener el mismo nombre que en el program
                var claimsPrincipal = new ClaimsPrincipal(claimsIdentity);
                // Propiedades de autenticación
                HttpContext.SignInAsync("AreaAct7Cookies", claimsPrincipal);
        ...
        {
            HttpContext.SignOutAsync("AreaAct7Cookies");
