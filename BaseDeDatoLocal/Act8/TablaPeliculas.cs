using TP_Final_Programacion5.Areas.Act8.Models;

namespace TP_Final_Programacion5.BaseDeDatoLocal.Act8
{
    static class TablaPeliculas
    {
        ...
        static public bool CrearPelicula(string titulo, DateTime fecha, string genero, decimal precio)
        {
            try
            {
